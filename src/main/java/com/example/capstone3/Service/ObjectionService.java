...
public class ObjectionService {
    ...
    public void approveObjection(Integer id, ObjectionResponseDTO response) {
        Objection objection = objectionRepository.findObjectionById(id);
        if (objection == null) {
            throw new ApiException("Objection id not found");
        }
        ...
        if (response != null) {
            objection.setResponse(response.getResponse());
        }

        objectionRepository.save(objection);
    }

    public void rejectObjection(Integer id, ObjectionResponseDTO response) {
        Objection objection = objectionRepository.findObjectionById(id);
        if (objection == null) {
            throw new ApiException("Objection id not found");
        }
